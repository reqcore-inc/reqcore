/**
 * 301 redirect from the legacy applirank.com domain to WWMate.com.
 *
 ...
 *
 * Also handles non-www â†’ www normalization if ever needed, and ensures HTTPS.
 */
const LEGACY_HOSTS = new Set(['applirank.com', 'www.applirank.com'])
const CANONICAL_ORIGIN = 'https://WWMate.com'
