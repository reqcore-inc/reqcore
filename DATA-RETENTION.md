...
- **Erasure**: a single erasure service removes the candidate's data graph in the
  ...
  (analysis runs and screening question scenarios), interviews, responses,
  custom properties, comments, and activity-log entries.
...
- **Data-subject support**: per-candidate JSON export (Art. 15 / 20) covering the
  ...
  AI-generated screening question scenarios, comments, custom properties, and
