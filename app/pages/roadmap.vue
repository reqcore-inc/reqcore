...
const items: RoadmapItem[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Open jobs count and status breakdown',
      'Quick actions: create job, add candidate',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Production Docker Compose and deploy guide',
      'HTTPS/TLS configuration',
      'Postgres and MinIO backup & restore',
      'GDPR data export and deletion',
      'Full test suite: API + E2E',
