      ...
      <div class="relative w-full max-w-md rounded-xl border border-surface-200 bg-white shadow-xl dark:border-surface-800 dark:bg-surface-900">
        ...
        <div class="space-y-4 px-5 py-5">
          ...
          <p class="text-sm text-surface-500 dark:text-surface-400">
            Get full read &amp; write access â€” choose the option that works best for you:
          </p>
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <div>
                ...
                <div class="text-xs text-surface-500 dark:text-surface-400 mt-0.5">Deploy on your own infrastructure â€” full control over your data</div>
              </div>
            </a>
          </div>
